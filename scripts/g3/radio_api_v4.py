...
KEYWORD_LOOKUP = {'news': 'news', 'ニュース': 'news', '新闻': 'news', 'nouvelles': 'news', 'nachrichten': 'news', 'noticias': 'news', 'notizie': 'news', 'новости': 'news', 'notícias': 'news', 'tin tức': 'news', 'ข่าว': 'news', 'berita': 'news', 'haberleri': 'news', 'jazz': 'jazz', 'ジャズ': 'jazz', '爵士': 'jazz', 'джаз': 'jazz', 'classical': 'classical', 'クラシック': 'classical', '古典': 'classical', 'classique': 'classical', 'klassik': 'classical', 'clásica': 'classical', 'classica': 'classical', 'классика': 'classical', 'clássica': 'classical', 'rock': 'rock', 'ロック': 'rock', '摇滚': 'rock', 'рок': 'rock', 'pop': 'pop', 'ポップ': 'pop', '流行': 'pop', 'поп': 'pop', 'electronic': 'electronic', '電子': 'electronic', 'электронная': 'electronic', 'electronica': 'electronic', 'électronique': 'electronic', 'elektronisch': 'electronic', 'hip hop': 'hip hop', 'ヒップホップ': 'hip hop', '嘻哈': 'hip hop', 'хип-хоп': 'hip hop', 'country': 'country', 'カントリー': 'country', '乡村': 'country', 'blues': 'blues', 'ブルース': 'blues', '蓝调': 'blues', 'блюз': 'blues', 'reggae': 'reggae', 'レゲエ': 'reggae', '雷鬼': 'reggae', 'metal': 'metal', 'メタル': 'metal', '金属': 'metal', 'folk': 'folk', 'フォーク': 'folk', '民謠': 'folk', 'фолк': 'folk', 'soul': 'soul', 'ソウル': 'soul', '灵魂': 'soul', 'dance': 'dance', 'ダンス': 'dance', '舞曲': 'dance', 'танцевальная': 'dance', 'ambient': 'ambient', 'アンビエント': 'ambient', '环境': 'ambient', 'lounge': 'lounge', 'ラウンジ': 'lounge', '休闲': 'lounge', '칠아웃': 'chillout', 'チルアウト': 'chillout', '放松': 'chillout', '토크': 'talk', 'トーク': 'talk', '脱口秀': 'talk', 'разговорное': 'talk', 'sports': 'sports', 'スポーツ': 'sports', '体育': 'sports', 'спорт': 'sports', 'deportes': 'sports', 'sport': 'sports', 'oldies': 'oldies', 'オールディーズ': 'oldies', '老歌': 'oldies', 'ретро': 'oldies', 'kpop': 'kpop', '韩流': 'kpop', 'jaypop': 'jpop', '日本流行': 'jpop', 'latin': 'latin', 'ラテン': 'latin', '拉丁': 'latin', 'christian': 'christian', 'クリスチャン': 'christian', '基督教': 'christian', 'христианская': 'christian', 'meditation': 'meditation', '瞑想': 'meditation', '冥想': 'meditation', 'медитация': 'meditation', '휴식': 'relaxing', 'リラックス': 'relaxing', '轻松': 'relaxing', 'расслабляющая': 'relaxing', '편안한': 'relaxing', 'workout': 'workout', 'ワークアウト': 'workout', '健身': 'workout', 'тренировка': 'workout', 'sleep': 'sleep', '睡眠': 'sleep', 'сон': 'sleep', 'study': 'study', '勉強': 'study', '学习': 'study', 'учёба': 'study', 'korea': 'korea', '韓国': 'korea', '韩国': 'korea', 'corée': 'korea', 'corea': 'korea', 'корея': 'korea', 'japan': 'japan', '日本': 'japan', 'japon': 'japan', 'japón': 'japan', 'япония': 'japan', 'china': 'china', '中国': 'china', 'chine': 'china', 'китай': 'china', 'usa': 'usa', 'アメリカ': 'usa', '美国': 'usa', 'états-unis': 'usa', 'estados unidos': 'usa', 'сша': 'usa', 'uk': 'uk', 'イギリス': 'uk', '英国': 'uk', 'royaume-uni': 'uk', 'reino unido': 'uk', 'великобритания': 'uk', 'france': 'france', 'フランス': 'france', '法国': 'france', 'франция': 'france', 'germany': 'germany', 'ドイツ': 'germany', '德国': 'germany', 'allemagne': 'germany', 'alemania': 'germany', 'германия': 'germany', 'spain': 'spain', 'スペイン': 'spain', '西班牙': 'spain', 'espagne': 'spain', 'españa': 'spain', 'испания': 'spain', 'italy': 'italy', 'イタリア': 'italy', '意大利': 'italy', 'italie': 'italy', 'italia': 'italy', 'италия': 'italy', 'russia': 'russia', 'ロシア': 'russia', '俄罗斯': 'russia', 'russie': 'russia', 'rusia': 'russia', 'россия': 'russia', 'brazil': 'brazil', 'ブラジル': 'brazil', '巴西': 'brazil', 'brésil': 'brazil', 'brasil': 'brazil', 'бразилия': 'brazil'}
...
class RadioAPI(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        try:
            ...
            # /stations/trending - clicktrend based popular rising broadcast
